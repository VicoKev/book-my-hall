...
<div class="collapse mb-4 <c:if test='${hasFilters}'>show</c:if>" id="filterPanel">
    <div class="card">
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/salles" method="get">
                <div class="row g-3">
                    <div class="col-md-4">
                ...
                <div class="row mt-3">
                    <div class="col-12 text-end">
                        <a href="${pageContext.request.contextPath}/salles" class="btn btn-outline-secondary">
...
<jsp:include page="../common/pagination.jsp">
    <jsp:param name="baseUrl" value="${pageContext.request.contextPath}/salles" />
