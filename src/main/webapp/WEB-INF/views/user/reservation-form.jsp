...
<div class="row mb-4">
    ...
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/user/reservations/create" 
...
<script>
    const prixParJour = <fmt:formatNumber value="${salle.prixParJour}" groupingUsed="false" />;
    ...
    document.getElementById('reservationForm').addEventListener('submit', function(e) {
        ...
        const capaciteMax = <fmt:formatNumber value="${salle.capacite}" groupingUsed="false" />;
