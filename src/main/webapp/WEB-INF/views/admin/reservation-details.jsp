...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item">
            <a href="${pageContext.request.contextPath}/admin/reservations">Gestion des Réservations</a>
        </li>
    ...
    <div class="col-lg-8">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="${pageContext.request.contextPath}/admin/salles/${reservation.salleId}" 
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/salles" 
                       class="btn btn-outline-secondary">
                        <i class="bi bi-building"></i> Gérer les salles
                    </a>
                </div>
            </div>
        </div>
