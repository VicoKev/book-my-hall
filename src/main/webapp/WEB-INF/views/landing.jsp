...
<div class="py-5 text-center bg-light">
  <div class="container">
    ...
    <p class="text-muted mb-4">
      Plus de 5 salles disponibles pour tous vos événements : mariages,
      anniversaires, séminaires, conférences et bien plus encore !
    </p>
      ...
      <sec:authorize access="isAuthenticated()">
        <sec:authorize access="hasAuthority('ADMIN')">
          <a
            ...
            class="btn btn-primary btn-lg px-4"
          >
            <i class="bi bi-gear"></i> Gérer les Salles
          </a>
        </sec:authorize>
        <sec:authorize access="hasAuthority('USER') and !hasAuthority('ADMIN')">
          <a
            href="${pageContext.request.contextPath}/user/salles"
            class="btn btn-primary btn-lg px-4"
          >
    ...
    <div class="col-md-4">
      <div class="card h-100 text-center p-4">
        <div class="card-body">
          ...
          <p class="card-text">
            Trouvez la salle parfaite parmi notre large sélection. Filtrez par
            capacité, localisation et budget.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card h-100 text-center p-4">
        <div class="card-body">
          ...
          <p class="card-text">
            Réservez en ligne facilement et rapidement. Système de vérification
    ...
    <div class="col-md-4">
      <div class="card h-100 text-center p-4">
        <div class="card-body">
          ...
          <p class="card-text">
            Profitez de votre événement dans la salle de vos rêves. Équipements
            modernes et service de qualité.
          </p>
        </div>
      </div>
    </div>
